...
struct retro_core_option_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "Reduce the volume of the Sound Channel 1.",
      {
         { "0",   NULL },
         { "10",  NULL },
         { "20",  NULL },
   ...
   },
   {
      ...
      "Reduce the volume of the Sound Channel 2.",
      {
         { "0",   NULL },
         { "10",  NULL },
         { "20",  NULL },
   ...
   },
   {
      ...
      "Reduce the volume of the Sound Channel 3.",
      {
         { "0",   NULL },
         { "10",  NULL },
         { "20",  NULL },
   ...
   },
   {
      ...
      "Reduce the volume of the Sound Channel 4.",
      {
         { "0",   NULL },
         { "10",  NULL },
         { "20",  NULL },
   ...
   },
   {
      ...
      "Sound Channel 5 Volume %",
      "Reduce the volume of the Sound Channel 5.",
      {
         { "0",   NULL },
         { "10",  NULL },
         { "20",  NULL },
   ...
   },
   {
      ...
      "Sound Channel 6 Volume %",
      "Reduce the volume of the Sound Channel 6.",
      {
         { "0",   NULL },
         { "10",  NULL },
         { "20",  NULL },
   ...
   },
   {
      ...
      "Sound Channel 7 Volume %",
      "Reduce the volume of the Sound Channel 7.",
      {
         { "0",   NULL },
         { "10",  NULL },
         { "20",  NULL },
   ...
   },
   {
      ...
      "Sound Channel 8 Volume %",
      "Reduce the volume of the Sound Channel 8.",
      {
         { "0",   NULL },
         { "10",  NULL },
         { "20",  NULL },
